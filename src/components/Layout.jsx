...
function HeroBanner() {
  ...
  return (
    <section className="hero-banner shadow mb-6 overflow-hidden relative rounded-2xl">
      <motion.div
      ...
      >
        <motion.span
          className="hero-badge mb-[10px] inline-block bg-orange-50 text-orange-600 dark:bg-orange-500/10 dark:text-orange-400 border border-orange-200 dark:border-orange-500/30 transition-colors shadow"
        ...
        >
          {[
            ...
            <div
              key={i}
              className="flex items-center bg-white dark:bg-slate-800 px-[14px] py-[6px] rounded-full shadow border border-slate-100 dark:border-slate-700"
            >
        ...
        >
          <Link
            to="/deals"
            className="inline-flex items-center justify-center rounded-full bg-orange-500 px-7 py-3 text-sm font-bold uppercase tracking-wider text-white shadow-lg transition-all duration-300 hover:bg-orange-600 hover:shadow-xl active:scale-95 hero-cta-primary"
          >
            Browse All Deals →
          </Link>
          ...
          <Link
            to="/categories"
            className="inline-flex items-center justify-center rounded-full border border-slate-300 bg-white px-7 py-3 text-sm font-bold uppercase tracking-wider text-slate-700 shadow-md transition-all duration-300 hover:border-orange-500 hover:text-orange-500 hover:shadow-lg dark:border-slate-600 dark:bg-slate-800 dark:text-slate-200 dark:hover:border-orange-400 dark:hover:text-orange-400 hero-cta-secondary"
          >
            View Categories
          </Link>
        </motion.div>
      ...
      <div className="absolute top-0 right-0 h-full w-1/2 bg-gradient-to-bl from-orange-100/50 to-transparent dark:from-orange-500/10 rounded-full blur-3xl opacity-50 z-0 translate-x-1/4 -translate-y-1/4"></div>

      {/* "As Seen On" Strip */}
      <div className="hero-seen-on-strip absolute bottom-0 left-0 flex w-full flex-wrap items-center gap-3 px-6 py-2">
