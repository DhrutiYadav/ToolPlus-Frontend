...
function CategoryCard({ category }) {
  ...
  return (
    ...
    >
      ...
      <h4 className="font-bold mb-2 text-slate-900 dark:text-white transition-colors">
        {name}
      </h4>
      <p className="line-clamp-2 mb-4 text-sm leading-6 text-slate-500 transition-colors dark:text-slate-400">
