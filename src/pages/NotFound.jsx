...
function NotFound() {
  return (
    <div className="d-flex flex-column align-items-center justify-content-center py-5 text-center not-found-shell">
      ...
      <p className="text-slate-500 dark:text-slate-400 mx-auto mb-4 transition-colors not-found-copy">
