...
function Home() {
  ...
  return (
    <div className="home-page">
      ...
      <section className="trust-statistics-section py-3 mb-3" ref={statsRef}>
        <div className="container px-0">
          <div className="row g-3">
            {stats.map((stat, index) => (
              ...
              >
                <motion.div
                  className="bg-white dark:bg-slate-900 p-[20px] rounded-4 text-center shadow-sm d-flex flex-column align-items-center justify-content-center border border-slate-100 dark:border-slate-800 transition-all duration-300 group"
                  whileHover={{ y: -8, boxShadow: "0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)" }}
                >
                  <div className="bg-orange-50 text-orange-600 dark:bg-orange-500/10 dark:text-orange-400 p-2 w-[48px] h-[48px] d-flex align-items-center justify-content-center rounded-circle mb-[10px] transition-transform duration-300 group-hover:scale-110 group-hover:bg-orange-100 dark:group-hover:bg-orange-500/20">
                    {stat.icon}
                  </div>
      ...
      {loading ? (
        ...
        <>
          ...
          {categories.length > 0 && (
            <section className="categories-section py-4 my-2">
              <div className="d-flex justify-content-between align-items-end mb-3">
                <div>
                  <span className="text-orange-500 fw-bold text-uppercase fs-7 tracking-wider transition-colors">Browse 50+ Categories</span>
                  <h2 className="fw-extrabold text-slate-900 dark:text-white mt-1 transition-colors">Find Your Next Tool</h2>
                </div>
                <Link to="/categories" className="btn btn-outline-secondary border-slate-200 dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-800 rounded-pill px-4 fw-bold hover-lift transition-all duration-300 hover:shadow-sm">
                  View All &rarr;
                </Link>
              </div>
              <div className="row g-3">
          ...
          <section className="featured-deals-section py-4 my-2">
            <div className="d-flex justify-content-between align-items-end mb-3">
              <div>
              ...
              <Link to="/deals" className="btn btn-outline-secondary border-slate-200 dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-800 rounded-pill px-4 fw-bold hover-lift transition-all duration-300 hover:shadow-sm">
                See More Deals &rarr;
              </Link>
            </div>
          ...
          <section className="how-it-works-section py-[48px] my-3 bg-gradient-to-br from-orange-50/60 to-amber-50/30 dark:from-slate-900 dark:to-slate-800/60 rounded-4 border border-slate-100 dark:border-slate-800 shadow-sm transition-colors">
            <div className="text-center mb-[40px]">
              <span className="text-orange-500 fw-bold text-uppercase fs-7 tracking-wider transition-colors">Simple Process</span>
              <h2 className="fw-extrabold text-slate-900 dark:text-white mt-1 transition-colors">How It Works</h2>
            </div>
            <div className="position-relative">
              {/* Connecting line (desktop only) */}
              <div className="how-it-works-line d-none d-md-block"></div>
              <div className="row g-4 position-relative">
                {howItWorksSteps.map((step, index) => (
                  ...
                  >
                    <div className="text-center position-relative p-[24px]">
                      <div className="how-step-number">{step.step}</div>
                      <div className="how-step-icon bg-orange-500 text-white rounded-circle d-inline-flex align-items-center justify-content-center mb-3 shadow-md">
                        {step.icon}
                      </div>
                      <h4 className="fw-bold text-slate-900 dark:text-white mb-2 transition-colors">{step.title}</h4>
                      <p className="text-slate-500 dark:text-slate-400 fs-7 mb-0 transition-colors">{step.desc}</p>
                    </div>
                  </motion.div>
                ))}
              </div>
          ...
          <section className="testimonials-section py-4 my-2 transition-colors">
            ...
            <div className="testimonials-scroll-container">
              <div className="row g-3 flex-nowrap flex-md-wrap overflow-auto overflow-md-visible pb-2 pb-md-0 home-testimonials-row">
                {/* Testimonial 1 */}
                <div className="col-10 col-md-4 home-testimonial-item">
                  <div className="bg-white dark:bg-slate-900 p-[24px] rounded-4 shadow-sm border border-slate-100 dark:border-slate-800 hover-lift position-relative transition-all duration-300 hover:shadow-md group h-100">
                    ...
                    <p className="text-slate-800 dark:text-slate-200 fs-6 fw-medium mb-[12px] transition-colors">
                      "Saved thousands on software purchases. The lifetime deals are unbelievable and the support is top-notch."
                    </p>
                    <div className="d-flex align-items-center">
                      <div className="bg-orange-500 text-white rounded-circle d-flex align-items-center justify-content-center fw-bold me-3 transition-colors home-avatar-45">SJ</div>
                      <div>
                ...
                <div className="col-10 col-md-4 home-testimonial-item">
                  <div className="bg-white dark:bg-slate-900 p-[24px] rounded-4 shadow-sm border border-slate-100 dark:border-slate-800 hover-lift position-relative transition-all duration-300 hover:shadow-md group h-100">
                    ...
                    <div className="d-flex align-items-center">
                      <div className="bg-slate-800 dark:bg-slate-700 text-white rounded-circle d-flex align-items-center justify-content-center fw-bold me-3 transition-colors home-avatar-45">MD</div>
                      <div>
                ...
                <div className="col-10 col-md-4 home-testimonial-item">
                  <div className="bg-white dark:bg-slate-900 p-[24px] rounded-4 shadow-sm border border-slate-100 dark:border-slate-800 hover-lift position-relative transition-all duration-300 hover:shadow-md group h-100">
                    ...
                    <div className="d-flex align-items-center">
                      <div className="bg-emerald-500 text-white rounded-circle d-flex align-items-center justify-content-center fw-bold me-3 transition-colors home-avatar-45">EC</div>
                      <div>
      ...
      <section className="benefits-section py-[40px] my-2 bg-gradient-to-br from-slate-50 to-orange-50/50 dark:from-slate-900 dark:to-slate-800/50 rounded-4 p-4 text-center position-relative overflow-hidden shadow-sm transition-colors border border-slate-100 dark:border-slate-800">
        ...
        <div className="position-relative z-1">
          ...
          <h2 className="fw-extrabold text-slate-900 dark:text-white mt-1 mb-3 transition-colors">The ToolPlus Guarantee</h2>
          ...
          <div className="row g-3 mt-1">
            {whyUsItems.map((item, index) => (
              ...
              >
                <div className="bg-white dark:bg-slate-800 p-[24px] rounded-4 shadow-sm border border-slate-100 dark:border-slate-700 h-100 hover-lift transition-all duration-300 hover:shadow-md">
                  <div className={`${item.bg} ${item.color} w-[52px] h-[52px] rounded-circle d-flex align-items-center justify-content-center mx-auto mb-3 transition-colors`}>
                    {item.icon}
                  </div>
                  <h5 className="fw-bold mb-2 text-slate-900 dark:text-white transition-colors">{item.title}</h5>
                  <p className="text-slate-500 dark:text-slate-400 fs-7 mb-0 transition-colors">{item.desc}</p>
                </div>
              </motion.div>
            ))}
          </div>
