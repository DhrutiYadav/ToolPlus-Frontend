  ...
  return (
    <div className="categories-page py-5">
      ...
      <div className="text-center mb-5">
        ...
        <p className="lead text-slate-500 dark:text-slate-400 mx-auto transition-colors" style={{ maxWidth: "600px" }}>
          Filter deals by business niche. Find exactly what your project needs from marketing to development.
        </p>
        
        {/* Inline Category Search */}
        <div className="mx-auto mt-4" style={{ maxWidth: "450px" }}>
      ...
      {loading ? (
        ...
        <div className="text-center py-5 border border-slate-100 dark:border-slate-800 rounded-4 bg-white dark:bg-slate-900 card-shadow transition-colors">
          <div className="bg-orange-50 text-orange-600 dark:bg-orange-500/10 dark:text-orange-400 rounded-circle d-inline-flex align-items-center justify-content-center mb-3 transition-colors" style={{width: '60px', height: '60px'}}>
